...
return [
     ...
     */
    'description' => 'Example of an api client using Star Wars API. Added few more endpoints including more advanced search.',
    ...
    'auth' => [
         ...
         * Options: query, body, basic, bearer, navigation (for custom navigation)
         */
        'in' => 'bearer',

        /*
         * The name of the auth parameter (eg token, key, apiKey) or navigation (eg Authorization, Api-Key).
         */
        'name' => 'key',
